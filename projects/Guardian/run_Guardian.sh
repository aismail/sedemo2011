...
java -Xmx2048m -Xms1900m -Xss128m -Djava.library.path=/usr/local/lib:$HYPERMEDIA_ROOT:$LIBOPENTLD4J_ROOT:$LIBOPENTLD_ROOT:$JSON_ROOT:$FACE4J_ROOT:$CARTAGO_ROOT:$SIMPLEOPENNI_ROOT -cp $JASON_ROOT/lib/jason.jar:$HYPERMEDIA_ROOT:$PROCESSING_ROOT:$LIBOPENTLD4J_ROOT:$JSON_ROOT:$FACE4J_ROOT$MISC_JARS:$CARTAGO_ROOT/cartago.jar:$CARTAGO_ROOT/c4jason.jar:$SIMPLEOPENNI_ROOT/SimpleOpenNI.jar:./build:. jason.infra.centralised.RunCentralisedMAS Guardian.mas2j
